...
// Para compilar el proyecto, escribe "npx tsc" en la consola. De acuerdo a las reglas definidas en el archivo "tsconfig.json" en este caso, se genera una carpeta dist, en el cual contiene el codigo compilado a javascript del proyecto actual

/* */

// LIMPIEZA DEL PROYECTO

// Elimina el archivo server.ts y limpia el archivo index.ts
